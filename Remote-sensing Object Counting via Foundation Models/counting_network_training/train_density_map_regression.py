...
CONFIG = {
    ...
    #CSRNet
    "csrnet_imagenet_pretrained": True,
    "vgg16_weights_path": "",

    "use_augmentation": True,
    "hflip_prob": 0.5,
    "vflip_prob": 0.0,
    "rot90_prob": 0.5,      # randomrotate(onlyincommandinprobabilitywhen)
    "jitter_prob": 0.8,     # colorperturb
...
def train_one_epoch(
    ...
    for img, gt_density, gt_count, _ in loop:
        ...
        gt_count = gt_count.to(device)      # gt_count is"originalcount"
